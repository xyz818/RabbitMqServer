...
public class accountController {
    ...
    @RequestMapping(value = "/{sid}/users", method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiImplicitParams({
    ...
    @RequestMapping(value = "/{uid}/user", method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiImplicitParams({
