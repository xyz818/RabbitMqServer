...
public class deviceInifoController {
    ...
    @RequestMapping(value = "/{pid}/deviceinfo", method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiImplicitParams({
    ...
    @RequestMapping(value = "/deviceinfo/{did}", method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiImplicitParams({
    ...
    @RequestMapping(value = "/deviceinfo", method = RequestMethod.PUT,consumes = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
